...
namespace Algorand.Unity.Samples.LocalAccountFlow
{
    ...
    public class LocalAccountFlowView : MonoBehaviour
    {
        ...
        // Hàm lưu chuỗi 25 từ vào PlayerPrefs
        private void SaveStringToPlayerPrefs(string inputString)
        {
            PlayerPrefs.SetString("SavedString", inputString);
            PlayerPrefs.Save();
            Debug.Log("String saved successfully!");
        }

        // Hàm lưu địa chỉ ví vào PlayerPrefs
        public void SaveWalletAddress(string walletAddress)
        {
            PlayerPrefs.SetString("WalletAddress", walletAddress);
            PlayerPrefs.Save();
            Debug.Log("Wallet address saved successfully!");
        }
        ...
        public void ConfirmNewAccount()
        {
            ...
            Debug.Log("newAccountView.mnemonic.RefValue: " + newAccountView.mnemonic.RefValue);
            MnemonicManager.Instance.Mnemonic = newAccountView.mnemonic.RefValue;
            SaveStringToPlayerPrefs(newAccountView.mnemonic.RefValue);
            ...
            Debug.Log("accountStore Address: " + accountStore[accountStore.Length - 1].ToString());
            SaveWalletAddress(accountStore[accountStore.Length - 1].Address.ToString());
        }
        ...
        public void ImportAccount()
        {
            ...
            Debug.Log("mnemonic.RefValue: " + mnemonic.RefValue);
            MnemonicManager.Instance.Mnemonic = mnemonic.RefValue;
            SaveStringToPlayerPrefs(mnemonic.RefValue);
